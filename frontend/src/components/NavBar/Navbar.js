		...
		return (
			<div>
				<Navbar style={{ backgroundColor: "#F2F3F7" }} light expand="md">
					...
					<NavbarToggler className="pull-right" onClick={this.toggleCollapse} />
					<Collapse isOpen={this.state.isOpen} navbar>
						<Nav navbar>
							<NavItem>
								...
								>
									<BsFillHouseDoorFill size="2em" style={{ margin: "auto" }} />
									Home
								</NavLink>
							</NavItem>
							<NavItem>
								<NavLink
									...
									className="nav-link d-flex flex-column"
									activeClassName="activeLink"
									onClick={() => window.history.pushState("", "", "/building")}
								>
							...
							<NavItem>
								...
								>
									<FaUserCircle size="2em" style={{ margin: "auto" }} />
					...
					<div style={{ marginRight: "2rem" }}>
						...
						>
							<DropdownToggle caret>{locale}</DropdownToggle>
							<DropdownMenu>
								<DropdownItem onClick={this.changeLocale}>English</DropdownItem>
